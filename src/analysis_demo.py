...
def last_year_by_team(eng_df, backlog_series=None, bank_holidays=None):
    ...
    di = IntervalAnalysis.build_interval_frame(eng_df, backlog_series=backlog_series, bank_holidays=bank_holidays)
    trend = IntervalAnalysis.monthly_trend_last_year(di, metric='days_to_pg_signoff', agg='median', by=['team']).copy()
