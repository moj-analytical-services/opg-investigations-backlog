...
# tests/test_logit_pipeline.py
from data import generate_synthetic, basic_clean, engineer_intervals
from modeling import fit_legal_review_enet


def test_enet_fits_and_scores():
    df = engineer_intervals(basic_clean(generate_synthetic(1200, seed=9)))
